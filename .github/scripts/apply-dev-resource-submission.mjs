...
import { buildDevResourcePullRequest, validateDevResourceIssue } from "./dev-resource-submission-lib.mjs";
...
await writeFile(args.output, JSON.stringify(buildDevResourcePullRequest(event.issue.number, resource), null, 2));
